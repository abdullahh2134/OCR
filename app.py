...
def extract_patient_data(full_text):
    ...
    patterns = {
        ...
        'Alkaline_Phosphotase': r"Alkaline Phosphotase \(Alkphos\):\s*(\d+)",
        'Alamine_Aminotransferase': r"Sgpt \(Alamine Aminotransferase\):\s*(\d+)",
        'Aspartate_Aminotransferase': r"Sgot \(Aspartate Aminotransferase\):\s*(\d+)",
